...
namespace TemplateEngine.Docx
{
	public class ListItemContent : Container, IEquatable<ListItemContent>
	{
		...
		public ListItemContent(IContentItem[] contentItems):base(contentItems)
                {
                }
		...
		public ListItemContent(IEnumerable<ListItemContent> nestedfields, IContentItem[] contentItems)
			: base(contentItems)
		{
		...
		public ListItemContent(string name, string value, ListItemContent[] nestedfields)
		{
			Fields = new List<FieldContent> {new FieldContent {Name = name, Value = value}};
			NestedFields = nestedfields.ToList();
		...
		public static ListItemContent Create(string name, string value, ListItemContent[] nestedfields)
		{
